...
def compute_sizes_all_gts(path_db):
    """
...
def get_gt_range_index_imgs(video_name, path_db):
    """
    ...
    :param path_db: Path of the DDBB folder
    :return: the ground truth range of the images of the video, and the name of the video
    """
    path_images = os.path.join(path_db, video_name, 'images')
...
def search_in_dataset_an_image_from_yolo_dataset(framename, path_db):
    """
...
def read_segmentation(video_name, path_db):
    """
    Reads the segmentation file and returns the segmentation.
    params:
        video_name: name of the video
        path_db: Path of the database folder
    returns:
...
if __name__ == '__main__':
    ...
    compute_sizes_all_gts(GLOBAL_PATH_DB)
